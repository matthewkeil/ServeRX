...
export default class Router {
	...
	public caseSensitive: any;
	public strict: any;
	public stack: Array<any>;
	constructor(options?: {caseSensitive: any, mergeParams: any, strict: any}) {
		this.opts = options || {};
		this.params = {};
		this._params = [];
	...
	public process_params(layer, called, req, res, done) {
    ...
    */
	...
	public appendMethods(list, addition) {
	...
	public mergeParams(params, parent) {
	...
	public sendOptionsResponse(res, options, next) {
		try {
